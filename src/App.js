...
const TWITTER_HANDLE = 'asfandyarHere';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const RARIBLE_COLLECTION_LINK = 'https://rinkeby.rarible.com/user/0xe59c75bc2559b7cb088ea57deeaaf481942f863e/owned';
const TOTAL_MINT_COUNT = 50;
const CONTRACT_ADDRESS = "0x15a6D2C3Ac8b79EBA7887B2AFd529F6189F4a82e"; 
...
const App = () => {
  ...
  */
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          // alert(`Hey there! We've minted your NFT and sent it to your wallet. It may be blank right now. It can take a few minutes to show on rarible. Here's the link: https://rinkeby.rarible.com/token/${CONTRACT_ADDRESS}/${tokenId.toNumber()}`)

          setRaribleLink(`https://rinkeby.rarible.com/token/${CONTRACT_ADDRESS}/${tokenId.toNumber()}`);
        });
  ...
  const navigateToRarible = () => {
    window.open(RARIBLE_COLLECTION_LINK, '_blank');
  }
    ...
    <div className="App">
      <div className="container" >
        <div className="header-container">
          <p className="header gradient-text">Legend NFT</p>
          <p className="sub-text">
            Each unique. Each beautiful. Mint your NFT today.
          </p>
          <button onClick={navigateToRarible} className="cta-button opensea-button">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          {isSuccessfulMint && (
            <div className="success-message">
              ...
              <p>View your NFT on <a className="opensea-link" href={raribleLink} target="_blank" rel="noreferrer">Rarible</a></p>
            </div>
          )}
        </div>
